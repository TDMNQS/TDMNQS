...
SynapsGraph AI — Research Discovery & Connected Knowledge
...
AI-Powered Personalized Learning Path Generator — A Roadmap Around the Learner
...
Resume Job Match AI — From Resume to Application Feedback

Compare a resume with a job description, understand the gaps, and prepare a more targeted application.

My adapted version of Resume Job-Fit AI, customized under the Resume Job Match AI name with Gemini model configuration changes.
